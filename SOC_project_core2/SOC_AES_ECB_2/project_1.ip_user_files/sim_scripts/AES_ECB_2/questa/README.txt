...
#
# Generated by export_simulation on Fri Oct 25 13:16:50 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './AES_ECB_2.sh' script.

./AES_ECB_2.sh -reset_run
...
./AES_ECB_2.sh -noclean_files

For more information on the script, please type './AES_ECB_2.sh -help'.
