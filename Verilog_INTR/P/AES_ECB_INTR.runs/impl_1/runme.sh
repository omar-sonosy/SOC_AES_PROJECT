...
HD_PWD='H:/SOC_Project/SOC_AES_PROJET/SOC_AES_PROJECT/SOC_Verilog_Core_With_INTR/SOC_AES_ECB_INTR/AES_ECB_INTR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_ECB_INTR_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_ECB_INTR_wrapper.tcl -notrace
