...
HD_PWD='H:/SOC_Project/SOC_AES_PROJECT/SOC_project_core2/SOC_AES_ECB_2_edited/SOC_AES_ECB_2_version2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_ECB_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_ECB_wrapper.tcl -notrace
