...
HD_PWD='H:/SOC_Project/SOC_AES_PROJECT/SOC_project_core2/SOC_AES_ECB_2_edited/SOC_AES_ECB_2_version2.runs/AES_ECB_AES_ECB_2_version2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_ECB_AES_ECB_2_version2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_ECB_AES_ECB_2_version2_0_0.tcl
