...
HD_PWD='H:/SOC_Project/SOC_AES_PROJET/SOC_AES_PROJECT/VHDL_INTR/VHDL_INTR/VHDL_INTR.runs/AES_F_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_F_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_F_auto_pc_0.tcl
