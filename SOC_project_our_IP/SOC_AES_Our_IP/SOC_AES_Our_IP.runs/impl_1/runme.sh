...
HD_PWD='H:/SOC_Project/SOC_AES_PROJECT/SOC_project_our_IP/SOC_AES_Our_IP/SOC_AES_Our_IP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SOC_Our_IP_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SOC_Our_IP_wrapper.tcl -notrace
