...
HD_PWD='H:/project/SoC_project/SoC_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_aes_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_aes_wrapper.tcl -notrace
