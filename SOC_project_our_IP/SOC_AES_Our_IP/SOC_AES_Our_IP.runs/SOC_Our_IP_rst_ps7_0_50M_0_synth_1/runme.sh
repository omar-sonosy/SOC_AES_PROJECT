...
HD_PWD='H:/SOC_Project/SOC_AES_PROJECT/SOC_project_our_IP/SOC_AES_Our_IP/SOC_AES_Our_IP.runs/SOC_Our_IP_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SOC_Our_IP_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SOC_Our_IP_rst_ps7_0_50M_0.tcl
