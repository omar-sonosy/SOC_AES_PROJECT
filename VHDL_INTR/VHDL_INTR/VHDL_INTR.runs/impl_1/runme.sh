...
HD_PWD='H:/SOC_Project/SOC_AES_PROJET/SOC_AES_PROJECT/VHDL_INTR/VHDL_INTR/VHDL_INTR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_F_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_F_wrapper.tcl -notrace
