...
################################################################
# This is a generated script based on design: AES_ECB_INTR
#
...
# source AES_ECB_INTR_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create instance: AES_ECB_INTR_0, and set properties
  set AES_ECB_INTR_0 [ create_bd_cell -type ip -vlnv inpg.fr:user:AES_ECB_INTR:1.0 AES_ECB_INTR_0 ]

  # Create instance: AES_ECB_INTR_DEC_0, and set properties
  set AES_ECB_INTR_DEC_0 [ create_bd_cell -type ip -vlnv inpg.fr:user:AES_ECB_INTR_DEC:1.0 AES_ECB_INTR_DEC_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AES_ECB_INTR_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins AES_ECB_INTR_DEC_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net AES_ECB_INTR_0_intr [get_bd_pins AES_ECB_INTR_0/intr] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net AES_ECB_INTR_DEC_0_intr_dec [get_bd_pins AES_ECB_INTR_DEC_0/intr_dec] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AES_ECB_INTR_0/s00_axi_aclk] [get_bd_pins AES_ECB_INTR_DEC_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins AES_ECB_INTR_0/s00_axi_aresetn] [get_bd_pins AES_ECB_INTR_DEC_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AES_ECB_INTR_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AES_ECB_INTR_DEC_0/S00_AXI/S00_AXI_reg] -force
