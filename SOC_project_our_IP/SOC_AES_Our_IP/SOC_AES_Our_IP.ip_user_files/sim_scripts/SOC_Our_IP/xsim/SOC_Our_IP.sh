...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SOC_Our_IP xil_defaultlib.SOC_Our_IP xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SOC_Our_IP -key {Behavioral:sim_1:Functional:SOC_Our_IP} -tclbatch cmd.tcl -protoinst "protoinst_files/SOC_Our_IP.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SOC_Our_IP.wdb xsim.dir)
