...
HD_PWD='H:/project/SoC_project/SoC_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_aes_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_aes_wrapper.tcl
