...
#
# Generated by export_simulation on Thu Oct 24 17:54:14 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './AES_ECB.sh' script.

./AES_ECB.sh -reset_run
...
./AES_ECB.sh -noclean_files

For more information on the script, please type './AES_ECB.sh -help'.
