...
HD_PWD='D:/esisar/SOC/soc_git/SOC_AES_PROJECT/SOC_project_our_IP_improved/project/SOC_AES_Improved.runs/AES_Improved_AES_improved_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_Improved_AES_improved_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_Improved_AES_improved_0_0.tcl
