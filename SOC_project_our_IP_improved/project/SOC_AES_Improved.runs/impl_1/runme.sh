...
HD_PWD='D:/esisar/SOC/soc_git/SOC_AES_PROJECT/SOC_project_our_IP_improved/project/SOC_AES_Improved.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_Improved_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_Improved_wrapper.tcl -notrace
