...
HD_PWD='H:/SOC_Project/SOC_AES_PROJET/SOC_AES_PROJECT/SOC_Verilog_Core_With_INTR/SOC_AES_ECB_INTR/AES_ECB_INTR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_ECB_INTR_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_ECB_INTR_wrapper.tcl
