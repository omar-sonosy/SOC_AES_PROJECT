...
#
# Generated by export_simulation on Wed Oct 09 11:05:01 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './design_aes.sh' script.

./design_aes.sh -reset_run
...
./design_aes.sh -noclean_files

For more information on the script, please type './design_aes.sh -help'.
