...
HD_PWD='H:/project/SoC_project/SoC_project.runs/design_aes_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_aes_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_aes_rst_ps7_0_50M_0.tcl
